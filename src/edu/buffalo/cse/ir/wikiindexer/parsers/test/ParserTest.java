...
public class ParserTest extends PropertiesBasedTest {
	...
	private static final String[] titles = { "Russ Conway", "Kathie Kay",
			"Alan Breeze", "Billy Cotton Band Show", "Billy Cotton" };
	private static final int[] ids = { 1356489, 1587174, 12879874, 1276897,
			252332 };
	private static final String[] authors = { "2.96.87.226", "1exec1",
			"Addbot", "Johnpacklambert", "Narrow Feint" };
	private static final String[] dates = { "2013-08-22T23:11:44Z",
			"2012-11-26T22:46:48Z", "2013-03-17T11:44:07Z",
			"2013-02-15T01:55:34Z", "2013-08-10T07:38:40Z" };
	private static final int[] numsections = { 8, 4, 3, 1, 6 };
	private static final String[] sectitles = { "Default", "Biography",
			"References", "Default", "References" };
	private static final int[] numcategories = { 8, 6, 4, 5, 13 };
	private static final String[] cattitles = { "1925 births", "2005 deaths",
	...
	private void validateSections(WikipediaDocument doc, int cnt) {
		...
		//System.out.println("DEBUG: Section title: "+doc.getSections().get(0).getTitle());
